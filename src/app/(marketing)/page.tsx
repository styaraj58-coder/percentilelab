...
export default async function HomePage() {
  ...
  const heroHighlights = [
    {
      ...heroHighlightsBase[0],
      value: null as number | null,
      text: exams.map((exam) => exam.shortName).join(", "),
    },
    {
      ...heroHighlightsBase[1],
      value: tests.length,
      text: ` mock ${tests.length === 1 ? "test" : "tests"} live now.`,
    },
    {
      ...heroHighlightsBase[2],
      value: submittedAttemptCount,
      text: " percentile reports generated.",
    },
    {
      ...heroHighlightsBase[3],
      value: explainedQuestionCount,
      text: " explained questions.",
    },
  ];
